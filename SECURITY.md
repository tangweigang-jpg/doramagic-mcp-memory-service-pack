...
This repository is an independent AI context resource pack for doobidoo/mcp-memory-service. It is not MCP Memory Service's official security contact.
...
Upstream product vulnerabilities should be reported to doobidoo/mcp-memory-service's own security policy. Link the upstream advisory here only when this pack needs a mitigation or warning.
